...
export default function Navbar() {
  ...
  <div className="navbar-brand">
    ...
    <div className="navbar-burger" data-target="navbarExampleTransparentExample" onClick={()=> setBurgerState(!burgerState)}>
      <span></span>
      <span></span>
      <span></span>
    </div>
  ...
  <div id="navbarExampleTransparentExample" className={burgerState?"navbar-menu":""}>
